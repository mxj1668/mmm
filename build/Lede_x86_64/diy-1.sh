...
rm -rf ./package/lean/luci-theme-argon && git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon package/luci-theme-argon  #删除lean主题安装新的argon主题
rm -rf ./package/lean/luci-theme-netgear                                                                                              #删除netgear主题
